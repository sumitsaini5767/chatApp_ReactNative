...
const OnBoarding = () => {
    ...
    return (
        <View style={styles.MainContainer}>
            ...
            {/* logo section */}
            <Image
                source={imagepath.gradientCircleBg}
                style={styles.bgCircleImage}
            />
            ...
            {/* subtitile section */}
            <Text style={styles.subtitle}>Our chat app is the perfect way to stay connected with friends and family.</Text>
